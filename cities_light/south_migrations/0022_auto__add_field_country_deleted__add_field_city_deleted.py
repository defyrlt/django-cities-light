...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.deleted'
        db.add_column(u'cities_light_country', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'City.deleted'
        db.add_column(u'cities_light_city', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.deleted'
        db.delete_column(u'cities_light_country', 'deleted')

        # Deleting field 'City.deleted'
        db.delete_column(u'cities_light_city', 'deleted')
